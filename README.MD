...
<div>
  <img src="./figs/CLE_char5.png" alt="Precision plot (top 10)e" style="float: left; margin-right: 10px;" />
  <img src="./figs/OR_char5.png" alt="Success rate plot (top 10)" style="float: left;" />
</div>
